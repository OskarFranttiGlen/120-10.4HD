  ...
  <div>
    ...
    <section class="booking-section">
      <div class="container">
        ...
        <form class="booking-form" id="bookingForm" @submit.prevent="checkAvailability" novalidate aria-label="Booking Form">
          <div class="row g-3">
  ...
  data() {
    return {
      ...
      galleryImages: [
        ...
        { src: 'https://picsum.photos/1600/900?hotel2', alt: 'Room Image 2' },
        { src: 'https://picsum.photos/1600/900?hotel3', alt: 'Room Image 3' }
      ],
      checkinDate: '',
      checkoutDate: '',
      guests: '',
      ...
      reviews: [
        { quote: "The Rooms were absolutely luxurious and comfortable. Highly recommend!", author: "Sarah M." },
        { quote: "Top-notch service and amazing rooms. I had a wonderful experience.", author: "John D." },
        { quote: "The Rooms were worth every penny. Will definitely come back!", author: "Emily W." }
      ]
    }
  },
  methods: {
